    ...
    <div className="flex justify-center bg-[#212529] min-h-screen">
      <div className="w-full max-w-[480px] bg-[#f8f9fa] relative min-h-screen flex flex-col px-6 py-12 overflow-hidden shadow-2xl transition-colors duration-300">
        ...
        <button 
          ...
          type="button" 
          className="w-full bg-white border border-[#ced4da] text-[#495057] font-bold py-3.5 rounded-xl flex items-center justify-center gap-3 mb-8 shadow-sm hover:bg-[#f8f9fa] hover:text-[#212529] active:scale-[0.98] transition-all"
        >
          <GoogleIcon />
          Entrar com Google
        </button>
